...
final class TypeBookView: UIView {
    ...
    private func setupCollection() {
        ...
        collectionView.register(TypeBookCollectionViewCell.self, forCellWithReuseIdentifier: TypeBookCollectionViewCell.identifier)
...
extension TypeBookView: UICollectionViewDataSource {
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        guard let cell = collectionView.dequeueReusableCell(withReuseIdentifier: TypeBookCollectionViewCell.identifier, for: indexPath) as? TypeBookCollectionViewCell else {
...
extension TypeBookView: UICollectionViewDelegate {
